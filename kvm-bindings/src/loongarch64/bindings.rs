...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(zerocopy::FromBytes, zerocopy::IntoBytes, zerocopy::Immutable))]
pub struct kvm_regs {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of kvm_regs"][::std::mem::size_of::<kvm_regs>() - 264usize];
    ["Alignment of kvm_regs"][::std::mem::align_of::<kvm_regs>() - 8usize];
    ["Offset of field: kvm_regs::gpr"][::std::mem::offset_of!(kvm_regs, gpr) - 0usize];
    ["Offset of field: kvm_regs::pc"][::std::mem::offset_of!(kvm_regs, pc) - 256usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(zerocopy::FromBytes, zerocopy::Immutable))]
pub struct kvm_fpu {
    pub fcsr: __u32,
    pub fcc: __u64,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of kvm_fpu_kvm_fpureg"][::std::mem::size_of::<kvm_fpu_kvm_fpureg>() - 32usize];
    ["Alignment of kvm_fpu_kvm_fpureg"][::std::mem::align_of::<kvm_fpu_kvm_fpureg>() - 8usize];
    ["Offset of field: kvm_fpu_kvm_fpureg::val64"]
        [::std::mem::offset_of!(kvm_fpu_kvm_fpureg, val64) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of kvm_fpu"][::std::mem::size_of::<kvm_fpu>() - 1040usize];
    ["Alignment of kvm_fpu"][::std::mem::align_of::<kvm_fpu>() - 8usize];
    ["Offset of field: kvm_fpu::fcsr"][::std::mem::offset_of!(kvm_fpu, fcsr) - 0usize];
    ["Offset of field: kvm_fpu::fcc"][::std::mem::offset_of!(kvm_fpu, fcc) - 8usize];
    ["Offset of field: kvm_fpu::fpr"][::std::mem::offset_of!(kvm_fpu, fpr) - 16usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of kvm_iocsr_entry"][::std::mem::size_of::<kvm_iocsr_entry>() - 16usize];
    ["Alignment of kvm_iocsr_entry"][::std::mem::align_of::<kvm_iocsr_entry>() - 8usize];
    ["Offset of field: kvm_iocsr_entry::addr"]
        [::std::mem::offset_of!(kvm_iocsr_entry, addr) - 0usize];
    ["Offset of field: kvm_iocsr_entry::pad"]
        [::std::mem::offset_of!(kvm_iocsr_entry, pad) - 4usize];
    ["Offset of field: kvm_iocsr_entry::data"]
        [::std::mem::offset_of!(kvm_iocsr_entry, data) - 8usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
